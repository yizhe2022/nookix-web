...
export const metadata: Metadata = {
  title: 'Page Not Found | Nookix',
  description: 'This page could not be found. Explore Nookix deep audio book summaries and curated book collections instead.',
  robots: {
    index: false,
    follow: false,
  },
...
/**
 * Custom 404 page
 * Provides friendly error information and navigation options
 */
export default async function NotFound() {
  ...
  try {
    ...
    console.error('[404 Page] Failed to fetch recommended books:', e)
  }
      ...
      <div className="flex items-center justify-center px-4 pb-8 pt-20 sm:pb-10 sm:pt-24">
        <div className="w-full max-w-md text-center">
          <div className="mb-6">
            ...
            <div className="mt-3 text-2xl font-semibold text-gray-700">Page Not Found</div>
          </div>
