...
export default async function GenreNotFound() {
  // 获取推荐书籍
  ...
  try {
    ...
    console.error('[Genre 404 Page] Failed to fetch recommended books:', e)
  }
    ...
    <div className="bg-[#FCFAF7] min-h-screen">
      <div className="flex items-center justify-center px-4 pb-8 pt-20 sm:pb-10 sm:pt-24">
        <div className="mx-auto w-full max-w-md text-center">
          ...
          <h2 className="mb-6 text-2xl font-semibold text-gray-800">Genre Not Found</h2>
