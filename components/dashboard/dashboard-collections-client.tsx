...
import { Clock, ArrowRight, BookOpen, Headphones, Loader2 } from "lucide-react"
...
export default function DashboardCollectionsClient({ 
  collections: initialCollections,
  hasMore: initialHasMore 
}: DashboardCollectionsClientProps) {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 lg:pt-20 pb-12 lg:pb-20">
      ...
      {/* 头条推荐书单 (Featured Collection) */}
      {featuredCollection && (
        <section className="relative group mb-12 lg:mb-20">
          <Link href={`/dashboard/collection/${featuredCollection.slug}`} className="block outline-none">
      ...
      <section>
        ...
        <div className="flex flex-col gap-6">
          {listCollections.map((collection) => (
            <Link key={collection.id} href={`/dashboard/collection/${collection.slug}`} className="group outline-none">
